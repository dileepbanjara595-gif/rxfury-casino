...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 py-8 mt-auto border-t border-neutral-800">
      ...
      <div className="container mx-auto px-4 mt-8 text-center text-xs text-neutral-500">
        &copy; {new Date().getFullYear()} RXFURY. All rights reserved.
      </div>
    </footer>
  );
}
